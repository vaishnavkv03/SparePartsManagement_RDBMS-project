  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-content">
        ...
        <a href="../admin_login/admin_login.php"><button class="login-btn">ADMINISTRATOR</button></a>
        <a href="../mech_login/mech_login.php"><button class="login-btn"> MECHANIC </button></a>
        <a href="../manuf_login/manu_login.php"><button class="login-btn">MANUFACTURER</button></a>
      </div>
    </div>
  </div>
</body>
